function[EEG] = LoadEEGDataMatlab(reading_matrix, dataset_name, channel_file, srate, save_dir, opt2)
    ...
    if save_dir
        file_path = [pwd '/processed_data/' save_dir '_Data'];
        mkdir(file_path);
    else
